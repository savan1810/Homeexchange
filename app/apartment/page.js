    ...
    return (
        ...
        <div className=''>
            <div className="mt-10 w-5/6  mx-auto grid gap-x-6 gap-y-8 xl:grid-cols-4  lg:grid-cols-3 sm:grid-cols-2 grid-cols-1">
                ...
                <div className='relative mx-auto group' >
                    <div className="relative -z-10  mb-2 rounded-2xl flex">
                        <Image height={270} width={270} className="rounded-2xl h-[300px] w-[300px] sm:h-[270px] sm:w-[270px] sm:object-cover sm:aspect-square" src={slides7[currentIndex7].url} alt="" />
                    </div>
                    <div className='hidden group-hover:block absolute top-[30%] left-5  rounded-full py-1 px-2 bg-black/30 text-white  cursor-pointer'>
                ...
                <div className='relative mx-auto group' >
                    <div className="relative -z-10  mb-2 rounded-2xl flex">
                        <Image height={270} width={270} className="rounded-2xl h-[300px] w-[300px] sm:h-[270px] sm:w-[270px] sm:object-cover sm:aspect-square" src={slides8[currentIndex8].url} alt="" />
                    </div>
                    <div className='hidden group-hover:block absolute top-[30%] left-5  rounded-full py-1 px-2 bg-black/30 text-white  cursor-pointer'>
